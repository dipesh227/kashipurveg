    ...
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked category-menu">
            ...
            <li class="<?php if (isset($_GET['pay_ofline'])) {
                ...
                <a href="my_account.php?pay_ofline"><i class="fa fa-bolt"></i> Pay Ofline</a>
            </li>
            <li class="<?php if (isset($_GET['my_address'])) {
                            echo "active";
                        } ?>">
                <a href="my_account.php?my_address"><i class="fa fa-user"></i> My Adderss</a>
            </li>
            ...
            <li class="<?php if (isset($_GET['del_acount'])) {
                ...
                <a href="my_account.php?del_acount"><i class="fa fa-trace"></i> Delete Account</a>
            </li>
